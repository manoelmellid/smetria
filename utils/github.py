...
def guardar_respuesta_en_csv(nombre, telefono, email, input_text, tipo_opc, mensaje, alerta_opc):
    ...
    nueva_fila = [respuesta_id, estado, fecha, nombre, telefono, email, latitud, longitud, tipo_opc, alerta_opc, mensaje_limpio]
    ...
    if response.status_code == 200:
        ...
        filas = [['id', 'estado', 'fecha', 'nombre', 'telefono','email', 'latitud', 'longitud', 'tipo_incidencia', 'tipo_alerta', 'comentario']]
