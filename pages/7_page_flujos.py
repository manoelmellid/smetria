...
if st.button("Enviar"):
    try:
        ...
        st.markdown(f"""
            ### Para el sensor <span style="color: red; font-weight: bold;">{zone_id}</span><br>
            en la fecha <span style="color: blue; font-style: italic;">{date}</span><br>
            a las <span style="color: green; font-weight: bold;">{hour}:00</span> """, unsafe_allow_html=True)
